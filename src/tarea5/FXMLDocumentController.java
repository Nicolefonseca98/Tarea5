...
//                
//                 mesasGridPane.setConstraints(table3ImageView, 2, 0);
//                mesasGridPane.getChildren().add(table3ImageView);
//                
//                 mesasGridPane.setConstraints(table4ImageView, 3, 0);
...
//                
//                 mesasGridPane.setConstraints(table6ImageView, 1, 1);
//                mesasGridPane.getChildren().add(table6ImageView);
//                
//                 mesasGridPane.setConstraints(table7ImageView, 2, 1);
//                mesasGridPane.getChildren().add(table7ImageView);
//                
//                 mesasGridPane.setConstraints(table8ImageView, 3, 1);
